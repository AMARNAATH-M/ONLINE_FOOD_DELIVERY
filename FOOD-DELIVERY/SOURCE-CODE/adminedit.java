...
public class adminedit extends JFrame {
	...
	public adminedit() {
		...
		JLabel lblDelizhAdd = new JLabel("DELIZH - ADD RESTAURANT");
		lblDelizhAdd.setFont(new Font("Agency FB", Font.BOLD, 30));
		lblDelizhAdd.setBounds(140, 10, 267, 36);
		...
		JLabel lblDelizhRemove = new JLabel("DELIZH - REMOVE RESTAUTANT");
		lblDelizhRemove.setFont(new Font("Agency FB", Font.BOLD, 30));
		lblDelizhRemove.setBounds(140, 10, 297, 36);
		...
		JLabel lblNewLabel_1 = new JLabel("DELIZH - ADD FOOD");
		lblNewLabel_1.setFont(new Font("Agency FB", Font.BOLD, 30));
		lblNewLabel_1.setBounds(140, 10, 267, 36);
		...
		JLabel lblDelizhRemove_1 = new JLabel("DELIZH - REMOVE FOOD");
		lblDelizhRemove_1.setFont(new Font("Agency FB", Font.BOLD, 30));
		lblDelizhRemove_1.setBounds(140, 10, 267, 36);
		...
		JLabel lblDelizhAdd_1 = new JLabel("DELIZH - ADD COUPON");
		lblDelizhAdd_1.setFont(new Font("Agency FB", Font.BOLD, 30));
		lblDelizhAdd_1.setBounds(140, 10, 267, 36);
		...
		JLabel label = new JLabel("DELIZH - REMOVE FOOD");
		label.setFont(new Font("Agency FB", Font.BOLD, 30));
		label.setBounds(140, 10, 267, 36);
		panel_10.add(label);
		...
		JLabel lblDelizhHistory = new JLabel("DELIZH - HISTORY");
		lblDelizhHistory.setFont(new Font("Agency FB", Font.BOLD, 30));
		lblDelizhHistory.setBounds(140, 10, 178, 36);
